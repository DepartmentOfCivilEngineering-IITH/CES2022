                      ...
                      <li className="nav-item">
                        ...
                        <div className="collapse" id="collapseExamples">
                          <div className="card card-body">
                            ...
                            <li data-bs-dismiss="offcanvas"><NavLink exact activeClassName="active_class" to="team_2425" className="dropdown-item">Team 2024-2025</NavLink></li>
            ...
            <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
              <ul className="navbar-nav ">
                ...
                <li className="nav-item dropdown">
                  ...
                  <li><NavLink exact activeClassName="active_class" to="team_2425" className="dropdown-item">Team 2024-2025</NavLink></li>
